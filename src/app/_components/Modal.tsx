  ...
  return (
    <Overlay onClick={handleOverlayClick}>
      <motion.div
        ...
        {...modalMotion}
        className="flex m-4 min-w-[300px] max-w-[510px] w-full pb-6 px-10 pt-10 flex-col items-start gap-12 rounded-2xl bg-white-0 dark:bg-black-4 dark:border shadow-md"
      >
        {/* 텍스트 */}
