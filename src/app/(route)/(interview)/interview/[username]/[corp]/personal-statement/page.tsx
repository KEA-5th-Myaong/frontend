    ...
    <section className="interview-container">
      ...
      <div className="flex flex-col self-stretch pt-2 w-full">
        ...
        <div className="flex gap-3 pt-3 whitespace-nowrap">
          <motion.div className="w-full max-w-64 py-4 px-5 bg-gray-4 dark:bg-black-4 dark:border font-bold rounded-[28px]">
            {corp}
          </motion.div>
          <motion.button
            type="button"
      ...
      <div className="flex flex-col self-stretch gap-5 w-full pb-12">
        {isLoading
          ? Array.from({ length: 5 }).map(() => (
              <div key={v4()} className="w-full h-32 bg-gray-200 dark:bg-black-5 rounded-md animate-pulse" />
            ))
