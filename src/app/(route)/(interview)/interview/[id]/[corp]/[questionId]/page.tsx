    ...
    <section className="flex flex-col pb-8 pr-8 interview-container">
      ...
      <div className="flex flex-col self-stretch pt-2 w-full pb-8">
        ...
        <div className="flex gap-3 pt-3 whitespace-nowrap">
          <div className="w-full max-w-64 py-4 px-5 bg-gray-4 font-bold rounded-[28px]">{corp}</div>
          <button type="button" onClick={router.back} className="py-4 px-6 rounded-[28px] primary-1-btn">
            포스트 작성
          </button>
        </div>
      </div>
