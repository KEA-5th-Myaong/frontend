...
export default function Footer({
  ...
  return (
    <div
      className={`fixed bottom-0 w-full flex items-center ${showPDF ? 'justify-between' : 'justify-end'} min-w-[360px] bg-white-0 dark:bg-black-5 dark:border-black-5 py-4 px-4 sm:px-16 
