...
export default function PortfolioAddCard() {
  return (
    <Link
      ...
      className="flex-center flex-col max-w-[320px] w-full py-[51px] bg-white-0 border border-gray-5 dark:bg-black-4 dark:border-black-5 rounded-xl transition-transform duration-200 hover:scale-105"
    >
