...
const usePortfolioStore = create<PortfolioState>((set) => ({
  //Fix - 임의 데이터
  portfolio: [
    { id: '1', title: '곽서연 포트폴리오 1', date: '2024.10.17' },
    { id: '2', title: '곽서연 포트폴리오 2', date: '2024.10.17' },
    { id: '3', title: '곽서연 포트폴리오 3', date: '2024.10.17' },
    { id: '4', title: '곽서연 포트폴리오 4', date: '2024.10.17' },
  ],
